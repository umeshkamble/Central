...
{
    public class KasVM : PanelVM<Kas>
    {
        #region Properties
        public override Kas Entity
        {
            set{
                ...
                this.IsGenerated = entity.IsGenerated;
        ...
        public KasVM(PanelEnum panelenum) : this(null, panelenum, 1, null) { }
        public KasVM(Kas entity, PanelEnum panelenum, int no, ImageSource imagesource) : base(entity, panelenum, no, imagesource) { }
        protected override void OnInitInput(Kas entity, PanelEnum panelenum)
        {
